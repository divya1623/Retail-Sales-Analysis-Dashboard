...
To analyze sales performance across different regions, states, and cities.
To understand customer segments and purchasing behavior.
To evaluate the impact of discounts on profit.
To create interactive visualizations for easy data analysis.
To support better business decisions using data insights.
